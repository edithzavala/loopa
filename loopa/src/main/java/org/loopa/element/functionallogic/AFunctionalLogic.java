...
public abstract class AFunctionalLogic extends ALoopAElementComponent implements IFunctionalLogic {
	...
	protected IFunctionalLogicEnactor functionalLogicEnactor;
	
	public AFunctionalLogic(String mainEndPoint, String adaptationEndPoint, IPolicyManager policyManager) {
		super(mainEndPoint, adaptationEndPoint, policyManager);
	}

	@Override
	public void enactFunctionalLogic(IMessage m) {
		functionalLogicEnactor.enactFunctionalLogic(m);
	}
}
