...
public class SimpleAutonomicManager {
    ...
    public SimpleAutonomicManager(IMonitor m, IAnalyzer a, IPlanner p, IExecuter e, IKnowledgeBase kb) {
	super();
	this.m = m;
	this.a = a;
	this.p = p;
	...
	/*
	 * codes used for distribute messages, e.g., analysis, could be also asked
	 * through policies as codes for distributing messages inside elements
	 */
